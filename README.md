...
| **写文章** | `content/article_template`（v2.0·5种类型）`content/公众号写作指南` `content/公众号内容生产经验手册`（17条教训+19条检查清单） |
...
公众号内容生产经验手册.md           ★ 17条教训+19条检查清单+标准流程
...
- 每次开新对话 → 先看 `ops/执行状态总表.md`
- 系统指令修改 → 同步更新 `meta/` 对应文件
- 每次拆解完成 → 填案例卡 `cases/2026/case-cards.md`
