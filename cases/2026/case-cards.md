...
> 所有案例的结构化摘要，用于跨案例检索和规律发现 格式说明：见 `content/case-card-format-v1.0.md` 每完成一次拆解，同时在这里新增一张卡 每10个案例做一次"规律发现" 最后更新：2026-08-03（文头对账：纠正 018 为骨架；对齐 `case-index.md` 的 017/018/021/023/025 状态；本文只标注覆盖缺口，不等于补齐新卡）
...
> **2026-08-03 对账说明**：现读实体稿确认 018 为九节骨架、正文待填；按 `case-index.md`，017 已发布，021 / 023 / 025 为成稿或终稿待发。CASE 编号不等同公众号文章编号；现读时以 `case-index.md` 判断文章发布状态，以本文判断案例卡覆盖状态。
>
> **待补卡清单 / 待补强清单（2026-08-03）**：
>
> | 文章编号 / 对象 | `case-index.md` 状态 | `case-cards.md` 当前状态 | 现读判断 |
> |---|---|---|---|
> | 017 / Cactus | ✅ 已发布（2026-06-11） | 已有 `CASE-012-Cactus`，卡内已对齐 017 已发布字段 | 已补卡，后续只需质量复核 |
> | 018 / 11x.ai | ⏳ 骨架草稿 | `CASE-013-Spangle` 仍写“待写（018）”，但 018 实际归属 11x.ai；需二次核对后拆分或改卡 | 待补强 / 待判是否需重建卡 |
> | 021 / Juicebox | ✅ 已成稿待发 | 本文未检索到 Juicebox 完整卡 | 待补卡 |
> | 023 / Anthropic | ✅ 已成稿待发 | 本文未检索到 Anthropic 完整卡 | 待补卡 |
> | 025 / 判断一个 AI 产品会不会死 | ✅ 终稿待发 | 本文未检索到 025 对应文卡/案例卡 | 待判是否需文卡；不得视为已补齐 |
...
article_file: "cases/2026/017-拆完30个AI产品我发现能赚钱的都先做对了一个动作.md"
article_published: "已发布 ✅（2026-06-11；文章编号017）"
depth_draft: "cases/2026/深度底稿/Cactus-拆解底稿.md"
```

---

## CASE-014 · 糖尿病前期——诊断空白系列第四个市场
